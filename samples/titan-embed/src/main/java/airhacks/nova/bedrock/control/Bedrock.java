...
public interface Bedrock {
        ...
        enum Model {
                TITAN_TEXT("amazon.titan-embed-text-v2:0", Region.US_EAST_1);
        ...
        static JSONObject createEmbeddings(String text,int dimension) {
                var modelId = nova.modelId();
                var client = bedrockRuntimeClient();
                var jsonRequest = Titan.payload(text, dimension);
